...
COPY --from=builder /go/src/github.com/papaburgs/fluffy-robot/internal/frontend/templates ./templates/
COPY --from=builder /go/src/github.com/papaburgs/fluffy-robot/internal/frontend/static ./static/
